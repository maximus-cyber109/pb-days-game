...
window.CR_CONFIG = {
  logo: "https://email-editor-resources.s3.amazonaws.com/images/82618240/PBD%20REDEMTION%20PAGE/logo.png",
  cards: {
  ...
  // productTier properties are loaded dynamically from reward-logic.js
  
  // REMOVED: No more sound properties
};
